...
class walmart_crawler(object):
    
    def __init__ (self):
        self.url = f'https://www.walmart.com/browse/electronics/tvs/3944_1060825_447913?page=1'
        self.driver = webdriver.Chrome("chromedriver.exe")
        self.w = input("Number of pages to scrape walmart: ")
    ...
    def crawler(self):
        ...
        last = int(w) * 24 - 1
        while num_page < last + 1:
            url = f"https://www.walmart.com/browse/electronics/tvs/3944_1060825_447913?page={num_page}"
            driver.implicitly_wait(10)
            driver.get(url)
            ...
            while True:
                ...
                prices_w = driver.find_element_by_css_selector("#viewport span.price-characteristic").text
        ...
        wdf.to_csv('walmart_tv_dataset.csv')
        print(name)
                
crawler = walmart_crawler()
crawler.crawler()